...
PushSocket.prototype.connect = function(destination, callback) {
  var self = this, ch = this.ch;
  ch.assertQueue(destination, {durable: this.options.persistent, autoDelete : this.options.autoDelete !== undefined ? this.options.autoDelete : false})
    .then(function(ok) {
...
PullSocket.prototype.connect = function(source, callback) {
  ...
  ch.assertQueue(source, {durable: this.options.persistent, autoDelete : this.options.autoDelete !== undefined ? this.options.autoDelete : false})
    .then(function(ok) {
...
function ReqSocket(channel, opts) {
  ...
  var setup = channel.then(function(ch) {
    return ch.assertQueue('', {exclusive:true, autoDelete:true, autoDelete : this.options.autoDelete !== undefined ? this.options.autoDelete : false})
      .then(function(ok) {
...
TaskSocket.prototype.connect = function(destination, callback) {
  ...
  this.ch.assertQueue(destination,
                 {durable: this.options.persistent, autoDelete : this.options.autoDelete !== undefined ? this.options.autoDelete : false})
    .then(function(ok) {
